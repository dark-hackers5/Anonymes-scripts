...
| **Catégorie**       | **Fonctionnalités** | **Description** | **Onglet** |
|----------------------|---------------------|----------------|------------|
| **🚤 Bateaux** | Auto Conduire Bateau | Conduit automatiquement le bateau vers l'avant | **Boats** |
| | Téléport vers Bateau | Se téléporte vers le bateau le plus proche | **Boats** |
| | Boat Speed Hack | Augmente la vitesse du bateau | **Boats** |
| **🌊 Events** | **Auto Leviathan (Quête complète)** ⭐ | Détection NPC → Vagues → Leviathan → Récompense | **Events** |
| | Auto Sea Beast | Tue automatiquement la Bête des Mers | **Events** |
| | Auto Pirate Raid | Participe au raid pirate | **Events** |
| | Auto Ship Raid | Participe au raid de navire | **Events** |
| | Auto Terrorshark | Tue automatiquement le requin terrifiant | **Events** |
| | Auto Volcano | Tue le Magma Admiral | **Events** |
| | Auto Factory | Tue le Mirror Boss | **Events** |
| **🎯 Quêtes** | **Auto Mirage Island (Quête)** ⭐ | Détection île → NPC → Ennemis → Récompense | **Quêtes** |
| | Auto Dough King | Tue le roi de la pâte | **Quêtes** |
| | Auto Yama | Tue Yama | **Quêtes** |
| | Auto Tushita | Tue Tushita | **Quêtes** |
| | Auto CDK | Tue le Cursed Dual Katana | **Quêtes** |
| | Auto Sanguine Art | Tue Sanguine Art | **Quêtes** |
| | Auto Kitsune | Tue Kitsune | **Quêtes** |
| | Auto Race V4 | Participe à la course V4 | **Quêtes** |
| **🗺️ Îles** | **Téléport vers Île Mirage** ⭐ | Se téléporte vers l'île Mirage si disponible | **Îles** |
| | Téléport vers toutes les îles | Liste complète des îles (First/Second/Third Sea) | **Îles** |
| | Auto Island Hop | Change de serveur automatiquement | **Îles** |
| **👁️ ESP** | ESP Players | Affiche les joueurs | **ESP** |
| | ESP Boss | Affiche les boss avec leur niveau | **ESP** |
| | ESP Fruits | Affiche les fruits au sol | **ESP** |
| | ESP Chests | Affiche les coffres | **ESP** |
| | ESP NPCs | Affiche les NPCs | **ESP** |
| **⚔️ Haki** | **Auto Haki (Complet)** ⭐ | Active Observation + Armament automatiquement | **Haki** |
| | Auto Observation (Ken) | Active le Haki d'Observation | **Haki** |
| | Auto Armament (Busoshoku) | Active le Haki d'Armement | **Haki** |
| **🚀 Movement** | Flight (Vol libre) | Permet de voler librement avec WASD + Espace/Shift | **Movement** |
| | Walk On Water | Marche sur l'eau | **Movement** |
| | Infinite Jump | Saut infini | **Movement** |
| | No Clip | Passe à travers les murs | **Movement** |
| **🛡️ Admin** | Anti Kick / Anti Ban | Réduit le lag pour éviter les kicks | **Admin** |
| | FPS Boost | Optimise les performances | **Admin** |
| | Server Hop | Change de serveur | **Admin** |
...
## 🔍 **COMPARAISON: SCRIPT VS JEU (CE QUI MANQUAIT)**

| **Fonctionnalité** | **Dans le Jeu** | **Dans le Script Précédent** | **Dans ce Script** | **Statut** |
|---------------------|------------------|-------------------------------|--------------------|------------|
| Conduite de bateaux | ✅ Oui | ❌ Non | ✅ Oui | **Ajouté** |
| Quête de Leviathan (complète) | ✅ Oui | ❌ Non (seulement le boss) | ✅ Oui (NPC + vagues + boss + récompense) | **Ajouté** |
| Détection intelligente des boss | ✅ Oui | ⚠️ Basique | ✅ Oui (par nom, niveau, type) | **Amélioré** |
| Île Mirage (détection + quête) | ✅ Oui | ❌ Non | ✅ Oui | **Ajouté** |
| ESP complet (joueurs, boss, fruits, coffres, NPCs) | ✅ Oui | ⚠️ Partiel | ✅ Oui | **Amélioré** |
| Haki automatique (Observation + Armement) | ✅ Oui | ❌ Non | ✅ Oui | **Ajouté** |
| Vol libre (Flight) | ❌ Non (sauf avec fruits) | ❌ Non | ✅ Oui | **Ajouté** |
| Téléportation vers toutes les îles | ✅ Oui | ❌ Non | ✅ Oui (liste complète) | **Ajouté** |
| Auto Island Hop | ✅ Oui | ❌ Non | ✅ Oui | **Ajouté** |
| Boat Speed Hack | ❌ Non | ❌ Non | ✅ Oui | **Ajouté** |
| Anti Kick / Anti Ban | ❌ Non | ❌ Non | ✅ Oui | **Ajouté** |
| FPS Boost | ❌ Non | ❌ Non | ✅ Oui | **Ajouté** |
| Quête Kitsune | ✅ Oui | ❌ Non | ✅ Oui | **Ajouté** |
| Quête Race V4 | ✅ Oui | ❌ Non | ✅ Oui | **Ajouté** |
| Auto Collect Rewards | ✅ Oui | ❌ Non | ✅ Oui | **Ajouté** |
...
### **1️⃣ Conduite de Bateaux (Onglet "Boats")**
- **Auto Conduire Bateau** : Active le bouton → le bateau avance **automatiquement** (évite les obstacles).
- **Téléport vers Bateau** : Clique pour te téléporter vers le **bateau le plus proche**.
- **Boat Speed Hack** : Augmente la **vitesse du bateau** (200 au lieu de 50).

---

### **2️⃣ Quête de Leviathan (Onglet "Events")**
- Active **"⭐ Auto Leviathan (Quête complète)"** → Le script :
  1. **Trouve le NPC "Old Man"** (sur une île aléatoire).
  2. **Parle au NPC** pour accepter la quête.
  3. **Tue les 3 vagues d'ennemis** (LeviathanWave1, LeviathanWave2, LeviathanWave3).
  4. **Tue Leviathan** (le boss final).
  5. **Retourne au NPC** pour obtenir la **récompense (Leviathan Gun)**.
- **⚠️ Important** : La quête **ne fonctionne que si tu as le niveau requis** (généralement **Lv. 150+**).

---

### **3️⃣ Île Mirage (Onglet "Îles")**
- **Téléport vers Île Mirage** : Clique pour te téléporter vers l'île **si elle est disponible** (apparaît aléatoirement).
- **⭐ Auto Mirage Island (Quête)** : Active le bouton → Le script :
  1. **Se téléporte sur l'île Mirage**.
  2. **Trouve le NPC "Mirage"**.
  3. **Accepte la quête**.
  4. **Tue tous les ennemis** sur l'île.
  5. **Retourne au NPC** pour la récompense.

---
### **4️⃣ Détection Intelligente des Boss**
- Le script **reconnaît maintenant** :
  - **Tous les boss par leur nom exact** (ex: `"Leviathan"`, `"Dough King"`).
  - **Leur niveau** (affiché dans l'ESP).
  - **Leur type** (Raid, Event, Quest, Normal).
- **Exemple** : Si tu actives **ESP Boss**, tu verras :
